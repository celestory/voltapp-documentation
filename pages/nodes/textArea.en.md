This node is a fully customizable text area. It allows the user to write text that can be used by the app. It's similare to input but expands on more than one line.
